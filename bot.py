...
boss = ['Abdielsn','josephPg','Luhan2293' ]#usuarios supremos

Configs = {"uclv":'',"gtm":"","uvs":"","ltu":"", 
			"ucuser": "", "ucpass":"","uclv_p":"", "gp":None, "s":"On", 
			'Abdielsn': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'josephPg': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'Luhan2293': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'Lisva81': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'bb0un_01': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'yordante': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'DaniX091': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
			'overlordox': {'z': 99,"m":"e","a":"c","t":"y","gp":False},
...
total_up = {'Abdielsn':{'P':0,'S':0},'josephPg':{'P':0,'S':0},'Luhan2293':{'P':0,'S':0},'Lisva81':{'P':0,'S':0},'bb0un_01':{'P':0,'S':0},'yordante':{'P':0,'S':0},'DaniX091':{'P':0,'S':0},'overlordox':{'P':0,'S':0}} #total en gb o megas subidos en bytes (int)
rvs = {'Abdielsn':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'josephPg':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'Luhan2293':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'Lisva81':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'bb0un_01':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'yordante':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'DaniX091':{'h':'','u':'','p':'','up':'','z':0,'m':'m'},'overlordox':{'h':'','u':'','p':'','up':'','z':0,'m':'m'}}
...
async def users(client: Client, message: Message):	
	...
	if username in boss:	
		...
		for user in Configs:
			...
			if user == "gp":continue
			if user == "s":continue
			if user == "Abdielsn":continue
			if user == "josephPg":continue
			if user == "Luhan2293":continue
			if user == "Lisva81":continue
			if user == "bb0un_01":continue
			if user == "yordante":continue
			if user == "DaniX091":continue
			if user == "overlordox":continue
